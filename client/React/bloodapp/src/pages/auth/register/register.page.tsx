...
import { InputType, PasswordInput, TextInput } from "../../../components/form/input";
...
export default function BloodRegisterDesign() {
  ...
  const submitEvent = (data: IRegisterForm) => {
            ...
            <form onSubmit={handleSubmit(submitEvent)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className="block">
                  ...
                  <TextInput control={control} name="fullName" placeholder="Your full name" type={InputType.TEXT} />
                </label>

                <label className="block">
                  <span className="text-sm font-medium">Email</span>
                  <TextInput control={control} name="email" placeholder="you@example.com" type={InputType.EMAIL} />
                </label>

                <label className="block">
                  <span className="text-sm font-medium">Password</span>
                  <PasswordInput control={control} name="password" placeholder="Create a password" />
                </label>

                <label className="block">
                  <span className="text-sm font-medium">Confirm Password</span>
                  <PasswordInput control={control} name="confirmPassword" placeholder="Repeat your password" />
                </label>
              </div>
